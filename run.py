...
def increment(app):
    ...
    for x in range(increments):
        ...
        temp_number = random.randint(current_number_distance, actual_number_distance)
...
increment.add_param("start", help="", default=1, type=int)
increment.add_param("end", help="", default=1, type=int)
increment.add_param("increments", help="", default=1, type=int)
increment.add_param("starting_point", help="", default=1, type=int)
